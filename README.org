...
I am the author.
Maybe I will further work on documentation and finalize the API after [[https://github.com/akirak/org-dog][org-dog]] has got basic features.
For now, I will continue with minor updates needed for my own use.
** Credits

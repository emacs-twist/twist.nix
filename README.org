...
** Status
- Functionalities: *Good*. The author builds his own [[https://github.com/akirak/nix-config][config]] with twist, and the config is already almost as capable as the previous version which depends on straight.el. [[https://github.com/emacs-twist/nomake][NoMake]] is used in some packages.
...
I am the author.
Maybe I will further work on documentation and finalizing the API after [[https://github.com/akirak/org-dog][org-dog]] has got basic features.
For now, I will continue minor updates needed for my own use.
** Credits
